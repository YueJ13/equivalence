...
#define ROWS 21440 //change to the number of networks in the first file. 
#define LINE_LENGTH 2048 
#define SPECIES 4 //change species
#define REACTIONS 5 //change reactions
...
int main() {
    ...
    FILE *file0 = fopen("445-new-binary-NY.txt", "r");//change to the file generated by the first code.
    if (!file0) {
    ...
    save_groups_to_file(groups, group_count, "445-new_binary_reff_new.txt");//change this output name 
